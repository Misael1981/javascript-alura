...
const importTvSimpsons = require('./dados.json')
console.log(importTvSimpsons)
...
const serieTvSimpsons = JSON.stringify(importTvSimpsons)
console.log(serieTvSimpsons)
console.log(typeof serieTvSimpsons)
